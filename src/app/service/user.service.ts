...
export class UserService {
  ...
  login(userName: string, password: string):Observable<any> {
    ...
    return this._http.post('https://dockerwebappha.azurewebsites.net/api/v1.0/tweets/login',body);
  }
  ...
  register(
    ...
    return this._http.post('https://dockerwebappha.azurewebsites.net/api/v1.0/tweets/register',body,options);
  }
  ...
  forgotPassword(
    ...
    return this._http.get('https://dockerwebappha.azurewebsites.net/api/v1.0/tweets/'+userName+'/Forgot',{params:queries});
  }
  ...
  allUser():Observable<any> {
    ...
    return this._http.get(
      'https://dockerwebappha.azurewebsites.net/api/v1.0/tweets/users/all', options);
  }
  ...
  searchUser(name:string):Observable<any> {
    ...
    let options = { headers: headers};
    return this._http.get(
      'https://dockerwebappha.azurewebsites.net/api/v1.0/tweets/user/search/'+name, options);
  }
}
